...
namespace _CurriculumManagerSystem.Controllers
{
    public class CLOPhuongphaphocsController : Controller
    {
        ...
        {
            return View(await _context.CLOPhuongphaphocs.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("maclopphoc,mucdo")] CLOPhuongphaphoc cLOPhuongphaphoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("maclopphoc,mucdo")] CLOPhuongphaphoc cLOPhuongphaphoc)
        {
