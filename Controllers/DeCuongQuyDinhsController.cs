...
namespace _CurriculumManagerSystem.Controllers
{
    public class DeCuongQuyDinhsController : Controller
    {
        ...
        {
            return View(await _context.DeCuongQuyDinhs.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("dcqd_id")] DeCuongQuyDinh deCuongQuyDinh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("dcqd_id")] DeCuongQuyDinh deCuongQuyDinh)
        {
