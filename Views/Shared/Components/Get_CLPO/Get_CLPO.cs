...
namespace _CurriculumManagerSystem.Views.Shared.Components.Get_CLPO
{
    //[ViewComponent]
    public class Get_CLPO : ViewComponent
    {
        private readonly acomptec_lvthainhanContext _context;

        public Get_CLPO(acomptec_lvthainhanContext context)
        {
            _context = context;
        }
