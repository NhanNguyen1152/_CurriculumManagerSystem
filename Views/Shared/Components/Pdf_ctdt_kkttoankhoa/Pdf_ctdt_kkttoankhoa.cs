...
namespace _CurriculumManagerSystem.Views.Shared.Components.Pdf_ctdt_kkttoankhoa
{
    public class Pdf_ctdt_kkttoankhoa :ViewComponent
    {
        private readonly acomptec_lvthainhanContext _context;

        public Pdf_ctdt_kkttoankhoa(acomptec_lvthainhanContext context)
        {
            _context = context;
        }
