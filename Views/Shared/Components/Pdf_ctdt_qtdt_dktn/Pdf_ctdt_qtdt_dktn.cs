...
namespace _CurriculumManagerSystem.Views.Shared.Components.Pdf_ctdt_qtdt_dktn
{
    public class Pdf_ctdt_qtdt_dktn : ViewComponent
    {
        private readonly acomptec_lvthainhanContext _context;

        public Pdf_ctdt_qtdt_dktn(acomptec_lvthainhanContext context)
        {
            _context = context;
        }
